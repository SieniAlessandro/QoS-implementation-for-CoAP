\chapter{Observer}
	...
	\section {Modifiche a Californium lato Client}
			...
			\subsection{CoapClient}\label{CoapClient}
				...
				\lstinputlisting[label={observeAndWaitNegotiation}, language=Java, firstline=1149, lastline=1187, caption={CoapClient, \href{https://tinyurl.com/y25fegl8}{codice originale}},captionpos=b]{../Codice/Java/CoapClient.java}
				...
				\lstinputlisting[label={deliver}, language=Java, firstline=1493, lastline=1515, caption={deliver, \href{https://tinyurl.com/y6gvpzrm}{codice originale}},captionpos=b]{../Codice/Java/CoapClient.java}


			\subsection{CoapObserveRelation}
				Variabili usate nel meccanismo di \textit{wait} e \textit{notify} spiegato in \ref{CoapClient}. \newline
				\lstinputlisting[label={CoapObserveRelationBoolean}, language=Java, firstline=68, lastline=71, caption={CoapObserveRelation, \href{https://tinyurl.com/y4ockh22}{codice originale}},captionpos=b]{../Codice/Java/CoapObserveRelation.java}
				\lstinputlisting[language=Java, firstline=114, lastline=138, caption={CoapObserveRelation, \href{https://tinyurl.com/y4ockh22}{codice originale}},captionpos=b]{../Codice/Java/CoapObserveRelation.java}
				Per resettare il gestore dell'ordine delle notifiche il contatore viene settato a 0.\newline
				\lstinputlisting[language=Java, firstline=308, lastline=312, caption={CoapObserveRelation, \href{https://tinyurl.com/y4ockh22}{codice originale}},captionpos=b]{../Codice/Java/CoapObserveRelation.java}
