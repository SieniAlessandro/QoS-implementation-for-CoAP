	...
	\section {Implementazione}
		\subsection {Modifiche a Californium lato Server}
			...
			\subsubsection{CoapResource}
				\paragraph{ServerState}
				Il proxy può decidere se accettare o meno le richieste in base allo stato corrente del nodo sensore, pertanto, è stato aggiunto un campo ServerState alla classe CoapResource. Se avviene un cambio di stato in \textbf{ONLY\_CRITICAL}, le relazioni con livello \textit{CoAP.QoSLevel.NON\_CRITICAL\_MEDIUM\_PRIORITY} e \textit{CoAP.QoSLevel.NON\_CRITICAL\_LOW\_PRIORITY} vengono cancellate, mentre se si passa ad \textbf{UNAVAILABLE}, tutte le relazioni di quella risorsa vengono cancellate. \newline
				\lstinputlisting[language=Java, firstline=161, lastline=163, caption={CoapResource serverState, \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
				\lstinputlisting[language=Java, firstline=218, lastline=232, caption={CoapResource funzioni serverState, \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
				\lstinputlisting[language=Java, firstline=576, lastline=584, caption={CoapResource clearNonCriticalObserveRelations, \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
				...
				\lstinputlisting[language=Java, firstline=180, lastline=183, caption={CoapResource sortedObservers, \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
				\lstinputlisting[language=Java, firstline=826, lastline=848, caption={CoapResource addObserveRelation(...), \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
				\lstinputlisting[language=Java, firstline=857, lastline=869, caption={CoapResource removeObserveRelation(...), \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
				\lstinputlisting[language=Java, firstline=932, lastline=942, caption={CoapResource notifyObserverRelations(...), \href{https://tinyurl.com/y264lheh}{codice originale}},captionpos=b]{../Codice/Java/CoapResource.java}
