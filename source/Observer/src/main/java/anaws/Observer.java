...
public class Observer {
  ...
  public int getQoSBits( int priority ) throws IllegalArgumentException {
	  int hex;
	  switch(priority) {
		  case 1: hex = 0x000000; break;
		  case 2: hex = 0x400000; break;
		  case 3: hex = 0x800000; break;
		  case 4: hex = 0xc00000; break;
    ...
    while(true) {
      System.out.print("Observer> ");
        switch(scanner.nextInt()) {
          case 1: observerClient.resourceDiscovery(); break;
          case 2: observerClient.resourceRegistration(); break;
          case 3: observerClient.resourceCancellation(); break;
          case 4: observerClient.printHelpMenu(); break;
          case 5: System.out.println("Exiting... Good bye!");
          		  System.exit(0); break;
          default: continue;
        }
    }
